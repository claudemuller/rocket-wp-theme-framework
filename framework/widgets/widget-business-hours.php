 ...
 *
 * Plugin Name: Rocket_Widget_Business_Hours
 * Plugin URI: http://mediarocket.co.za
...
class Rocket_Widget_Business_Hours extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __( 'Rocket: Business Hours', 'rocket' ),
            array(
                'classname'   => 'widget-business-hours',
                'description' => __( 'A custom widget that displays business hours', 'rocket' )
            )
        );
    }
...
add_action( 'widgets_init', create_function( '', 'register_widget( "Rocket_Widget_Business_Hours" );' ) );
